    ...
    <div className="max-w-4xl mx-auto my-8 prose">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            "Us" or "Our" in this Agreement) refers to Boundless Ventures, 150
            Woodward Rd, Manalapan Township, NJ 07726.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to BNDLS, accessible from{" "}
            <a
              href="https://www.bndls.app/"
      ...
      <ul>
        <li className="font-bold">
          By email: {process.env.NEXT_PUBLIC_SUPPORT_EMAIL}
        </li>
      </ul>
    </div>
  );
