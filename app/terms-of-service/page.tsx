...
function TermsOfService() {
  return (
    <div className="max-w-4xl mx-auto my-8 prose">
      <div>
        <div className="mb-4">
        ...
        <div>
          <div>
            <strong>Last updated</strong> <strong>April 05, 2024</strong>
          </div>
          <div>
        ...
        <div>
          <div>
            We are Boundless Ventures, doing business as BNDLS ("
            <strong>Company</strong>," "<strong>we</strong>," "
            <strong>us</strong>," "<strong>our</strong>"), a company registered
            in New Jersey, United States at 150 Woodward Rd, Manalapan Township,
        ...
        <div>
          <div>
            ...
            <a href="https://www.bndls.app/" target="_blank">
              https://www.bndls.app/
            </a>{" "}
          ...
          <div>
            {`You can contact us by email at ${process.env.NEXT_PUBLIC_SUPPORT_EMAIL} or by
            mail to 150 Woodward Rd, Manalapan Township, Manalapan Township, NJ
            07726, United States.`}
          </div>
          <div>
            These Legal Terms constitute a legally binding agreement made
            between you, whether personally or on behalf of an entity ("
            <strong>you</strong>"), and Boundless Ventures, concerning your
          ...
          <div>
            ...
            ${process.env.NEXT_PUBLIC_SUPPORT_EMAIL}, as stated in the email message. By
        ...
        <div className="my-8">
          ...
          <div>
            <a href="#thirdparty">11. THIRD-PARTY WEBSITES AND CONTENT</a>
          </div>
          <div>
        ...
        <div>
          ...
          <div>
            ...
            <a>PROHIBITED ACTIVITIES</a>" section below, we grant you a
          ...
          <div>
            ...
            please address your request to: ${process.env.NEXT_PUBLIC_SUPPORT_EMAIL}. If
        ...
        <div>
          ...
          <div>
            Please review this section and the "<a>PROHIBITED ACTIVITIES</a>"
          ...
          <ul>
            <li>
              ...
              <a>PROHIBITED ACTIVITIES</a>" and will not post, send, publish,
        ...
        <div>
          ...
          <strong>
            {" "}
            <a
              href="https://www.freeprivacypolicy.com/live/19792b3a-6755-42f2-93c5-50ac617c7944"
              target="_blank"
            >
              https://www.freeprivacypolicy.com/live/19792b3a-6755-42f2-93c5-50ac617c7944
            </a>
          </strong>
        ...
        <div>
          ...
          rules or applicable law, the arbitration will take place in Delaware.
        ...
        <div>
          ...
          and federal courts located inDelaware, and the Parties hereby consent
        ...
        <div>
          <strong>Boundless Ventures</strong>
        </div>
        <div>
          <strong>150 Woodward Rd, Manalapan Township</strong>
        </div>
        <div>
          <strong>Manalapan Township, NJ 07726</strong>
        </div>
        <div>
